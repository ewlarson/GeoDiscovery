...
ActiveRecord::Schema[7.0].define(version: 20_240_307_155_110) do
  ...
  create_table 'sidecar_image_transitions', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[solr_document_sidecar_id most_recent], name: 'index_sidecar_image_transitions_parent_most_recent',
                                                      unique: true
    t.index %w[solr_document_sidecar_id sort_key], name: 'index_sidecar_image_transitions_parent_sort', unique: true
  end
  ...
  create_table 'solr_document_sidecars', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[document_type document_id], name: 'sidecars_solr_document'
  end
